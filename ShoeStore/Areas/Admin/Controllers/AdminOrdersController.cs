...
namespace ShoeStore.Areas.Admin.Controllers
{
    ...
    public class AdminOrdersController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? page)
        {
            ...
            ViewBag.CurrenPage = pageNumber;
            return View(models);
            /* var shoeStoreContext = _context.Orders.Include(o => o.Customer).Include(o => o.TransactStatus);
        ...
        public async Task<IActionResult> ChangeStatus(int? id)
        {
            ...
            ViewData["TrangThai"] = new SelectList(_context.TransactionStatuses, "TransactStatusId", "Status", order.TransactStatusId);

            return PartialView("ChangeStatus", order);
        }
        [HttpPost]
        public async Task<IActionResult> ChangeStatus(int id, [Bind("OrderId,CustomerId,OrderDate,ShipDate,TransactStatusId,Deleted,Paid,PaymentDate,PaymentId,Note,Address,TotalMoney")] Order order)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (donhang != null)
                    {
                        donhang.Paid = donhang.Paid;
                        donhang.Deleted = donhang.Deleted;
                        donhang.TransactStatusId = donhang.TransactStatusId;
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,OrderDate,ShipDate,TransactStatusId,Deleted,Paid,PaymentDate,PaymentId,Note,Address,TotalMoney")] Order order)
        {
            if (ModelState.IsValid)
            {
                _context.Add(order);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,OrderDate,ShipDate,TransactStatusId,Deleted,Paid,PaymentDate,PaymentId,Note,Address,TotalMoney")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
