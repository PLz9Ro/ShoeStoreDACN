...
namespace ShoeStore.Models.VNPay
{
    public class PayLib
    {
        ...
        public string CreateRequestUrl(string baseUrl, string vnp_HashSecret, Util util)
        {
        ...
        public bool ValidateSignature(string inputHash, string secretKey, Util util)
        {
